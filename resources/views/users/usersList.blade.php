                                    ...
                                    <td>
                                        @php
                                            if ($item->last_activity) {
                                                $last = \Carbon\Carbon::parse($item->last_activity)->setTimezone(
                                                    'Asia/Jakarta',
                                                );
                                                ...
                                                if ($isActive && $last <= $now) {
                                                    ...
                                                    $timeInfo =
                                                        '(' . number_format($diffInMinutes, 0) . ' menit yang lalu)';
                                                } else {
                                                    $status = 'Offline';
                                        ...
                                        <span class="{{ $statusClass }}">
                                            {{ $status }} <span
                                                class="text-xs text-gray-500">{{ $timeInfo }}</span>
                                        </span>
                                    </td>
                                </tr>
                                @if (!in_array($currentRole, ['member', 'trainer']))
                                    ...
                                    <div id="edit-popup-modal-{{ $item->id }}" tabindex="-1"
                                        ...
                                        <div class="rounded-2xl bg-white max-w-[800px] w-full">
                                            <div
                                                ...
                                                <button data-modal-hide="edit-popup-modal-{{ $item->id }}"
                                                    type="button"
                                                    ...
                                                    <div class="grid grid-cols-1 gap-6">
                                                        ...
                                                        <div class="bg-gray-50 p-4 rounded-lg border border-gray-200">
                                                            <div class="grid grid-cols-2 gap-4">
                                                                <div>
                                                                    <label class="text-sm font-medium text-gray-500">Nama
                                                                        User:</label>
                                                                ...
                                                                <div>
                                                                    <label
                                                                        class="text-sm font-medium text-gray-500">Email:</label>
                                                                    <p class="text-base font-semibold text-gray-900">
                                                                        {{ $item->email }}</p>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div>
                                                            ...
                                                            <select id="role_{{ $item->id }}" name="role"
                                                                ...
                                                                <option value="spv"
                                                                    {{ $currentRole == 'spv' ? 'selected' : '' }}>
                                                                    Supervisor
                                                                    (SPV)
                                                                </option>
                                                                <option value="guest"
                                                                    {{ $currentRole == 'guest' ? 'selected' : '' }}>Guest
                                                                </option>
                                                            </select>
                                                            <p class="text-xs text-gray-500 mt-1">Role saat ini: <span
                                                                    class="font-semibold text-primary-600">{{ ucfirst($currentRole ?? 'Tidak ada role') }}</span>
                                                            </p>
                                                        </div>

                                                        <!-- Action Buttons -->
                                                        <div
                                                            class="flex items-center justify-end gap-3 mt-4 pt-4 border-t border-gray-200">
                                                            <button type="button"
