        ...
        <ul class="sidebar-menu" id="sidebar-menu">
            ...
            <li class="dropdown">
                ...
                <ul class="sidebar-submenu">
                    ...
                    <li>
                        <a href="{{ route('register') }}"><i class="ri-circle-fill circle-icon text-warning-600 w-auto"></i> Sign Up</a>
                    </li>
                    <li>
                        <a href="{{ route('password.request') }}"><i class="ri-circle-fill circle-icon text-info-600 w-auto"></i> Forgot Password</a>
                    </li>
                </ul>
            </li>
            <li>
