    ...
    <style>
        * {
        ...
        .card-container {
            ...
            /* 3.37 inch */
            height: 54mm;
            /* 2.125 inch - ukuran kartu kredit standar */
            margin: 10mm auto;
...
<body>
    <div class="card-container">
        ...
        <div class="card-body">
            ...
            @else
                <div
                    style="width: 60px; height: 60px; border-radius: 50%; background: rgba(255,255,255,0.3); float: left; margin-right: 12px; display: flex; align-items: center; justify-content: center; font-size: 24px; border: 3px solid white;">
                    👤
                </div>
            @endif
            ...
            <div class="member-info">
                ...
                @if ($anggota->status_keanggotaan)
                    <div
                        style="display: inline-block; background: rgba(46, 213, 115, 0.9); padding: 2px 8px; border-radius: 10px; font-size: 9px; font-weight: bold;">
                        ✓ ACTIVE MEMBER
                    </div>
                @endif
            </div>
    ...
    <div class="card-container" style="background: linear-gradient(135deg, #4a5568 0%, #2d3748 100%);">
        <div style="padding: 20px; color: white; height: 100%;">
            <h3
                style="font-size: 12px; margin-bottom: 10px; text-align: center; border-bottom: 1px solid rgba(255,255,255,0.3); padding-bottom: 8px;">
                TERMS & CONDITIONS
            </h3>
            ...
            <div
                style="position: absolute; bottom: 15px; left: 20px; right: 20px; text-align: center; border-top: 1px solid rgba(255,255,255,0.3); padding-top: 8px; font-size: 9px;">
