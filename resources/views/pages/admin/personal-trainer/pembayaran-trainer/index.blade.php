    ...
    AjaxTable.init('pembayaranTrainer', {
        ...
        renderRow: function (item) {
            ...
            if (item.is_lunas) {
                ...
                aksi = '<button type="button" class="open-bayar-trainer-modal w-8 h-8 bg-success-100 text-success-600 rounded-full inline-flex items-center justify-center" title="Bayar"'
