...
<body>
    ...
    <div class="summary">
        <div class="summary-row">
            <div class="summary-item">
                ...
                <div class="value">{{ $totalMemberTrainer }}</div>
            </div>
    ...
    <div class="info-section">
        ...
        <div class="info-row">
            ...
            <div class="info-value">{{ $memberTrainers->count() }} Transaksi</div>
        </div>
        <div class="info-row">
        ...
        <table>
            <thead>
                <tr>
                    ...
                    <th width="13%">Nama Anggota</th>
                    <th width="13%">Nama Trainer</th>
                    <th width="13%">Paket</th>
                    <th width="6%" class="text-center">Sesi</th>
                    <th width="9%" class="text-center">Tgl Bayar</th>
                    <th width="8%">Metode</th>
                    <th width="9%" class="text-right">Total Biaya</th>
                    <th width="9%" class="text-right">Terbayar</th>
            ...
            <tbody>
                @foreach ($memberTrainers as $index => $item)
                    ...
                    <tr>
                        ...
                        <td>{{ $item->paketPersonalTrainer->nama_paket ?? '-' }}</td>
                        <td class="text-center">{{ $sisaSesi }} / {{ $totalSesi }}</td>
            ...
            <tfoot>
                <tr style="background-color: #f0f0f0; font-weight: bold;">
                    ...
                    <td class="text-right" style="padding: 10px;">
                        Rp {{ number_format($memberTrainers->sum('total_biaya'), 0, ',', '.') }}
                    </td>
                    <td class="text-right" style="padding: 10px;">
                        Rp
                        {{ number_format(
                            $memberTrainers->sum(function ($item) {
    ...
    @else
        <div class="no-data">
            <p>Tidak ada data member trainer yang tersedia untuk filter yang dipilih.</p>
        </div>
    @endif
