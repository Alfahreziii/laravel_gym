        ...
        <div class="col-span-12">
            <div class="card border-0">
                <div class="card-header">
                    <h6 class="text-lg font-semibold mb-0">Form Edit Anggota & Akun Login</h6>
                </div>
                <div class="card-body">
                        ...
                        <div class="grid grid-cols-12 gap-4">
                            ...
                            <div class="col-span-12">
                                ...
                                <input type="text" name="id_kartu"
                                    ...
                                    value="{{ old('id_kartu', $anggota->id_kartu) }}" required>
                                @error('id_kartu')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-span-12 md:col-span-4">
                                ...
                                <input type="date" name="tgl_lahir"
                                    ...
                                    value="{{ old('tgl_lahir', $anggota->tgl_lahir->format('Y-m-d')) }}" required>
                                @error('tgl_lahir')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-span-12 md:col-span-4">
                                ...
                                <input type="date" name="tgl_daftar"
                                    ...
                                    value="{{ old('tgl_daftar', $anggota->tgl_daftar->format('Y-m-d')) }}" required>
                                @error('tgl_daftar')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-span-12 md:col-span-4">
                                ...
                                <select name="gol_darah" class="form-control @error('gol_darah') is-invalid @enderror"
                                    ...
                                    <option value="A"
                                        {{ old('gol_darah', $anggota->gol_darah) == 'A' ? 'selected' : '' }}>A</option>
                                    <option value="B"
                                        {{ old('gol_darah', $anggota->gol_darah) == 'B' ? 'selected' : '' }}>B</option>
                                    <option value="AB"
                                        {{ old('gol_darah', $anggota->gol_darah) == 'AB' ? 'selected' : '' }}>AB</option>
                                    <option value="O"
                                        {{ old('gol_darah', $anggota->gol_darah) == 'O' ? 'selected' : '' }}>O</option>
                                </select>
                                @error('gol_darah')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-span-12 md:col-span-4">
                                ...
                                <input type="number" name="tinggi"
                                    ...
                                    value="{{ old('tinggi', $anggota->tinggi) }}" required>
                                @error('tinggi')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-span-12 md:col-span-4">
                                ...
                                <input type="number" name="berat"
                                    ...
                                    value="{{ old('berat', $anggota->berat) }}" required>
                                @error('berat')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-span-12">
                                ...
                                <textarea name="riwayat_kesehatan" class="form-control @error('riwayat_kesehatan') is-invalid @enderror"
                                    rows="3">{{ old('riwayat_kesehatan', $anggota->riwayat_kesehatan) }}</textarea>
                            ...
                            <div class="col-span-12">
                                ...
                                <select name="status_finger"
                                    ...
                                    <option value="2"
                                        {{ old('status_finger', $anggota->status_finger) == '2' ? 'selected' : '' }}>—
                                        Default (Tidak Ada Aksi) —</option>
                                    <option value="0"
                                        {{ old('status_finger', $anggota->status_finger) == '0' ? 'selected' : '' }}>🟢
                                        Enroll Fingerprint</option>
                                    <option value="1"
                                        {{ old('status_finger', $anggota->status_finger) == '1' ? 'selected' : '' }}>🔴
                            ...
                            <div class="col-span-12">
                                ...
                                @if ($anggota->user->photo)
                                    <div class="mb-2">
                                        <img src="{{ asset('storage/' . $anggota->user->photo) }}" alt="Current Photo"
