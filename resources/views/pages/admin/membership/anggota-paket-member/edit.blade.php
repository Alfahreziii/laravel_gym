                            ...
                            @forelse($anggotaMembership->pembayaranMemberships as $index => $pembayaran)
                                <tr>
                                    ...
                                    <td class="whitespace-nowrap">
                                        {{ \Carbon\Carbon::parse($pembayaran->tgl_bayar)->format('d-m-Y') }}</td>
                                    <td class="whitespace-nowrap">Rp
                                        {{ number_format($pembayaran->jumlah_bayar, 0, ',', '.') }}</td>
                                    <td class="whitespace-nowrap">{{ $pembayaran->metode_pembayaran }}</td>
                                    @role('admin')
                                        <td class="whitespace-nowrap flex gap-2">
                                            <form action="{{ route('pembayaran_membership.destroy', $pembayaran->id) }}"
                        ...
                        <div class="grid grid-cols-12 gap-4">
                            ...
                            <div class="col-span-12">
                                ...
                                <input readonly type="text" id="tgl_mulai" class="form-control"
                                    value="{{ $anggotas->where('id', $anggotaMembership->id_anggota)->first()->name ?? '' }}"
                                    required>
                            </div>
                            ...
                            <div class="col-span-12 md:col-span-6">
                                ...
                                <input type="number" name="total_biaya" id="total_biaya"
                                    value="{{ old('total_biaya', $anggotaMembership->total_biaya) }}" class="form-control"
                                    readonly>
                            </div>
            ...
            <div class="p-6">
                <form action="{{ route('anggota_membership.tambahPembayaran', $anggotaMembership->id) }}" method="POST"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-12 gap-4">
                        ...
                        <div class="col-span-12">
                            <label class="form-label">Kode Transaksi</label>
                            <input type="text" class="form-control" value="{{ $anggotaMembership->kode_transaksi }}"
                                readonly>
                        </div>
                        ...
                        <div class="col-span-12">
                            ...
                            <small class="text-muted" id="modal_warning_text"
                        ...
                        <div class="col-span-12">
                            ...
                            <input type="text" id="modal_sisa_setelah"
                                class="form-control bg-success-50 border-success-200 text-success-600 font-semibold"
                                readonly>
                        </div>
