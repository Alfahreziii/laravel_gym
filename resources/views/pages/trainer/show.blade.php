                    ...
                    <div class="grid grid-cols-12 gap-4">
                        ...
                        <div class="col-span-12">
                            ...
                            @if ($trainer->user->photo)
                                <div class="mb-2">
                                    <img src="{{ asset('storage/' . $trainer->user->photo) }}" alt="Foto Trainer"
                        ...
                        <div class="col-span-12 md:col-span-4">
                            ...
                            <p class="form-control bg-gray-100">
                                {{ \Carbon\Carbon::parse($trainer->tgl_lahir)->format('d-m-Y') }}</p>
                        </div>
                        ...
                        <div class="col-span-12 md:col-span-6">
                            ...
                            <p class="form-control bg-gray-100">
                                {{ \Carbon\Carbon::parse($trainer->tgl_gabung)->format('d-m-Y') }}</p>
                        </div>
                        ...
                        <div class="col-span-12 mb-2">
                            ...
                            <div class="grid grid-cols-12 gap-4">
                                @foreach ($trainer->schedules as $jadwal)
                                    <div class="col-span-12 md:col-span-4">
                                        <p class="form-control bg-gray-100">{{ $jadwal->day_of_week }} :
                                            {{ $jadwal->start_time }} - {{ $jadwal->end_time }}</p>
                                    </div>
                                @endforeach
                            </div>
                        </div>
                        ...
                        <div class="col-span-12 mt-4">
                            <a href="{{ route('trainer.index') }}"
                                class="text-danger-600 border border-danger-600 rounded-lg px-6 py-3">Kembali</a>
                        </div>
