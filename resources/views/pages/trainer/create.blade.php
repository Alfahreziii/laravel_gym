                        ...
                        <div class="grid grid-cols-12 gap-4">
                            ...
                            <div class="col-span-12">
                                ...
                                <input type="text" name="rfid"
                                    class="form-control @error('rfid') is-invalid @enderror" value="{{ old('rfid') }}"
                                    required>
                                @error('rfid')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                ...
                                <select name="id_specialisasi"
                                    ...
                                    @foreach ($specialisasis as $specialisasi)
                                        <option value="{{ $specialisasi->id }}"
                                            {{ old('id_specialisasi') == $specialisasi->id ? 'selected' : '' }}>
                                ...
                                <div id="jadwal-container">
                                    <div class="jadwal-item grid grid-cols-12 gap-4 mb-2">
                                        ...
                                        <div class="col-span-12 md:col-span-3">
                                            ...
                                            <input type="time" name="jadwal[0][start_time]" class="form-control"
                                                required>
                                        </div>
                                        <div class="col-span-12 md:col-span-3">
                                            <label class="form-label">Jam Selesai</label>
                                            <input type="time" name="jadwal[0][end_time]" class="form-control"
                                                required>
                                        </div>
