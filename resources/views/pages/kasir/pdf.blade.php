    ...
    <div class="summary-section">
        ...
        <div class="summary">
            ...
            <div class="summary-row">
                ...
                <div class="summary-cell">Rp {{ number_format($totalDiskonBarang + $totalDiskonManual, 0, ',', '.') }}
                </div>
            </div>
            <div class="summary-row">
    ...
    @if ($filterType !== 'all')
        ...
        <div class="summary-section">
            ...
            <div class="summary">
                ...
                <div class="summary-row">
                    <div class="summary-cell">Total Seluruh Diskon</div>
                    <div class="summary-cell">Rp
                        {{ number_format($filteredTotalDiskonBarang + $filteredTotalDiskonManual, 0, ',', '.') }}</div>
                </div>
                <div class="summary-row">
                    <div class="summary-cell">Total HPP (Harga Pokok Penjualan)</div>
                ...
                <div class="summary-row">
                    <div class="summary-cell">Laba Kotor</div>
                    <div class="summary-cell">Rp
                        {{ number_format($filteredTotalPendapatan - $filteredTotalHPP, 0, ',', '.') }}</div>
                </div>
            </div>
        </div>
    @endif
        ...
        <div class="highlight-box">
            <table style="width: 100%; font-size: 10px;">
                <tr>
                    ...
                    <td style="text-align: right; width: 150px; padding: 3px;"><strong>Rp
                ...
                <tr>
                    ...
                    <td style="text-align: right; padding: 3px;"><strong>Rp
                            {{ number_format($transactions->sum('dibayarkan'), 0, ',', '.') }}</strong></td>
                </tr>
                <tr>
                    <td style="text-align: right; padding: 3px;"><strong>Total Kembalian:</strong></td>
                    <td style="text-align: right; padding: 3px;"><strong>Rp
                            {{ number_format($transactions->sum('kembalian'), 0, ',', '.') }}</strong></td>
                </tr>
                <tr>
                    <td style="text-align: right; padding: 3px;"><strong>Total HPP:</strong></td>
                    <td style="text-align: right; padding: 3px;"><strong>Rp
                            {{ number_format($transactions->sum('total_hpp_transaction'), 0, ',', '.') }}</strong></td>
                </tr>
                <tr>
                    <td style="text-align: right; padding: 3px;"><strong>Total Laba Kotor:</strong></td>
                    <td style="text-align: right; padding: 3px;"><strong>Rp
                            {{ number_format($transactions->sum('total_amount') - $transactions->sum('total_hpp_transaction'), 0, ',', '.') }}</strong>
                    </td>
                </tr>
            </table>
        </div>
