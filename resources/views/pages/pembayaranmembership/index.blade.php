                    ...
                    <tbody>
                        ...
                        <div id="edit-popup-modal-{{ $item->id }}" tabindex="-1" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                            <div class="rounded-2xl bg-white max-w-[800px] w-full">
                                ...
                                <div class="p-6">
                                    <form action="{{ route('pembayaran_membership.tambahPembayaran', $item->id) }}" method="POST" class="form-pembayaran" data-item-id="{{ $item->id }}">
                                        @csrf
                                        @method('PUT')
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-12 gap-4">
                                            ...
                                            <div class="col-span-12 md:col-span-6">
                                                ...
                                                <input type="text" class="form-control bg-gray-50" 
                                                    value="Rp {{ number_format($item->pembayaranMemberships->sum('jumlah_bayar'), 0, ',', '.') }}" readonly>
                                            </div>
                                            ...
                                            <div class="col-span-12">
                                                ...
                                                <input type="text" class="modal_sisa_tagihan form-control bg-danger-50 border-danger-200 text-danger-600 font-bold text-lg" 
                                                    value="Rp {{ number_format($item->total_biaya - $item->pembayaranMemberships->sum('jumlah_bayar'), 0, ',', '.') }}" readonly>
                                                <input type="hidden" id="sisa_tagihan_value_{{ $item->id }}"  class="sisa_tagihan_value" value="{{ $item->total_biaya - $item->pembayaranMemberships->sum('jumlah_bayar') }}">
                                            </div>
