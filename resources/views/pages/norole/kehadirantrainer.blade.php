...
<head>
    ...
    <title>Absensi Trainer - Gym System</title>
...
<body class="bg-neutral-100">
            ...
            <div class="col-span-12 lg:col-span-7 xl:col-span-8">
                ...
                <div class="grid grid-cols-4 gap-4 mb-6">
                    @php
                        ...
                        $todayData = $kehadirantrainers->filter(
                        ...
                        $uniqueTrainers = $todayData->unique('rfid')->count();
                    @endphp
                    ...
                    <div
                        ...
                        <div class="card-body p-5">
                            <div class="flex flex-wrap items-center justify-between gap-3">
                                <div>
                                    <p class="font-medium text-neutral-900 mb-1">Trainer Unik</p>
                                    <h6 class="mb-0">{{ $uniqueTrainers }}</h6>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-span-12 lg:col-span-5 xl:col-span-4">
                <div class="scanner-container">
                    <div class="card border-0 shadow-xl rounded-xl overflow-hidden">
                        ...
                        <div class="card-body p-6">
                            <form id="kehadiranForm" action="{{ route('absentrainer.store') }}" method="POST"
                            ...
                            <div class="mt-6 bg-blue-50 border border-blue-200 rounded-xl p-4">
                                ...
                                <ol class="list-decimal list-inside p-4 space-y-2 text-sm text-blue-700">
                                    ...
                                    <li>Arahkan scanner ke kartu trainer</li>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
                    ...
                    return `
                        <tr class="hover:bg-neutral-50 transition-colors">
                            ...
                            <td class="py-3 text-center whitespace-nowrap">
                                <button onclick="confirmDeleteAbsenTrainer('${item.delete_url}')"
            ...
            // ==================== FUNGSI HAPUS ====================
            window.confirmDeleteAbsenTrainer = function(url) {
                Swal.fire({
                    title: 'Hapus Data?',
