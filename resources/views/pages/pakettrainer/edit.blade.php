...
@php
    $title = 'Edit Paket Personal Trainer';
    $subTitle = 'Edit Paket Personal Trainer';
@endphp
                    ...
                    <div class="grid grid-cols-12 gap-4">
                        ...
                        <div class="col-span-12">
                            <div class="form-group flex items-center justify-end gap-2">
                                <button type="submit" class="btn btn-primary-600">Update Paket</button>
                                <a href="{{ route('paket_personal_trainer.index') }}" 
                                    ...
                                    dark:focus:ring-danger-800">Kembali</a>
                            </div>
                        </div>
                    </div>
                </form>
