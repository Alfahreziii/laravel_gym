    ...
    <div class="col-span-12">
        <div class="card border-0">
            <div class="card-header">
                <h6 class="text-lg font-semibold mb-0">Form Edit Produk</h6>
            </div>
            <div class="card-body">
                    ...
                    <div class="grid grid-cols-12 gap-4">
                        ...
                        <div class="col-span-12 md:col-span-3">
                            ...
                            <select name="discount_type" class="form-control">
                                ...
                                <option value="percent" {{ old('discount_type', $product->discount_type) == 'percent' ? 'selected' : '' }}>Persentase (%)</option>
                                <option value="nominal" {{ old('discount_type', $product->discount_type) == 'nominal' ? 'selected' : '' }}>Nominal (Rp)</option>
                            </select>
                        </div>
                        ...
                        <div class="col-span-12">
                            ...
                            <select name="kategori_product_id" class="form-control" required>
                                ...
                                @foreach($categories as $kategori)
                                    <option value="{{ $kategori->id }}" {{ old('kategori_product_id', $product->kategori_product_id) == $kategori->id ? 'selected' : '' }}>
                                        {{ $kategori->name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-span-12">
                            ...
                            @if($product->image)
                                <div class="mt-2">
                                    <img src="{{ asset('storage/' . $product->image) }}" alt="Gambar Produk" class="rounded-lg w-40 h-40 object-cover border">
                                </div>
                            @endif
                            <small class="text-gray-500">Kosongkan jika tidak ingin mengganti gambar. Format: jpg, jpeg, png, webp</small>
                        </div>
