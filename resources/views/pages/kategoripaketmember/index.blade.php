        ...
        <div class="card border-0 overflow-hidden">
            ...
            <div class="card-body">
                <table id="selection-table" class="border border-neutral-200 rounded-lg border-separate">
                    ...
                    <tbody>
                        @foreach($kategori_paket_memberships as $index => $kategori_paket_membership)
                        <tr>
                            ...
                            <td class="whitespace-nowrap">
                                ...
                                <!-- Form Delete -->
                                <form action="{{ route('kategori_paket_membership.destroy', $kategori_paket_membership->id) }}" method="POST" class="inline-block delete-form">
                                    @csrf
                                    @method('DELETE')
                        ...
                        <div id="edit-popup-modal-{{ $kategori_paket_membership->id }}" tabindex="-1" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                            <div class="rounded-2xl bg-white max-w-[800px] w-full">
                                <div class="py-4 px-6 border-b border-neutral-200 flex items-center justify-between">
                                    ...
                                    <button data-modal-hide="edit-popup-modal-{{ $kategori_paket_membership->id }}" type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center">
                                ...
                                <div class="p-6">
                                    <form action="{{ route('kategori_paket_membership.update', $kategori_paket_membership->id) }}" method="POST">
                                        @csrf
                                        @method('PUT')
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-12 gap-6">
                                            ...
                                            <div class="col-span-12">
                                                <label for="nama_kategori_{{ $kategori_paket_membership->id }}" class="inline-block font-semibold text-neutral-600 text-sm mb-2">Nama Kategori :</label>
                                                <input type="text" id="nama_kategori_{{ $kategori_paket_membership->id }}" name="nama_kategori" class="form-control rounded-lg" value="{{ $kategori_paket_membership->nama_kategori }}" required>
                                            </div>
                                            <div class="col-span-12">
                                                <div class="flex items-center justify-start gap-3 mt-6">
                                                    <button type="button" data-modal-hide="edit-popup-modal-{{ $kategori_paket_membership->id }}" class="border border-danger-600 hover:bg-danger-100 text-danger-600 text-base px-10 py-[11px] rounded-lg">
                                                        Cancel
                                                    </button>
...
<div id="popup-modal" tabindex="-1" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
    <div class="rounded-2xl bg-white max-w-[800px] w-full">
        ...
        <div class="p-6">
            <form action="{{ route('kategori_paket_membership.store') }}" method="POST">
            @csrf
            @method('POST')

                <div class="grid grid-cols-1 md:grid-cols-12 gap-6">
                    <div class="col-span-12">
                        <label for="title" class="inline-block font-semibold text-neutral-600 text-sm mb-2">Nama Kategori : </label>
                        <input type="text" id="title" name="nama_kategori" class="form-control rounded-lg" placeholder="Masukkan Nama Kategori " required>
                    </div>
                    <div class="col-span-12">
                        <div class="flex items-center justify-start gap-3 mt-6">
    ...
    deleteForms.forEach(form => {
        ...
        btn.addEventListener('click', function (e) {
            ...
            Swal.fire({
                ...
                text: "Data kategori_paket_membership yang dihapus tidak bisa dikembalikan!",
                icon: 'warning',
