...
@php
    $title = 'Tambah Kategori Membership';
    $subTitle = 'Tambah Kategori Membership';
@endphp
    ...
    <div class="col-span-12">
        <div class="card border-0">
            <div class="card-header">
                <h6 class="text-lg font-semibold mb-0">Form Tambah Kategori Membership</h6>
            </div>
            <div class="card-body">
                <form action="{{ route('anggota.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-12 gap-4">
                        ...
                        <div class="col-span-12">
                            ...
                            <input type="text" name="id_kartu" class="form-control" value="{{ old('id_kartu') }}" required>
                        </div>
                        <div class="col-span-12">
                        ...
                        <div class="col-span-12 sm:col-span-4">
                            ...
                            <input type="text" name="tinggi" class="form-control" value="{{ old('tinggi') }}">
                        </div>
                        <div class="col-span-12 sm:col-span-4">
                        ...
                        <div class="col-span-12">
                            ...
                            <textarea name="riwayat_kesehatan" class="form-control" rows="3">{{ old('riwayat_kesehatan') }}</textarea>
                        </div>
                        <div class="col-span-12">
                        ...
                        <div class="col-span-12">
                            <div class="form-group flex items-center justify-end gap-2">
                                <button type="submit" class="btn btn-primary-600">Tambah Anggota</button>
