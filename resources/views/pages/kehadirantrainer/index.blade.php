        ...
        <div class="grid grid-cols-12 gap-5 mb-5">
            <div class="col-span-12 lg:col-span-6">
                <div class="card border-0">
                    ...
                    <div class="card-body">
                        <form id="barcodeForm" action="{{ route('kehadirantrainer.store') }}" method="POST"
                        ...
                        <div class="mt-6 bg-gray-50 p-4 rounded-lg">
                            ...
                            <ol class="list-decimal list-inside space-y-1 text-sm text-neutral-600">
                                ...
                                <li>Arahkan barcode scanner ke kartu trainer</li>
                ...
                <div class="card border-0">
                    ...
                    <div class="card-body">
                        @php
                            ...
                            $todayAttendance = $kehadirantrainers->filter(function ($item) use ($today) {
                            ...
                            $uniqueTrainers = $todayAttendance->unique('rfid')->count();
                        @endphp
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div class="bg-success-50 p-4 rounded-lg text-center">
                                <div class="text-3xl font-bold text-success-600">{{ $uniqueTrainers }}</div>
                                <div class="text-sm text-neutral-600">Trainer Unik</div>
                            </div>
            ...
            <div class="card border-0 overflow-hidden">
                <div class="card-header flex items-center justify-between">
                    <h6 class="card-title mb-0 text-lg">
                        {{ $isLaporanMode ? 'Laporan Data Kehadiran Trainer' : 'Riwayat Kehadiran Trainer' }}</h6>
