...
@php
    $title = 'Tambah Alat Gym';
    $subTitle = 'Tambah Alat Gym';
@endphp
    ...
    <div class="col-span-12">
        <div class="card border-0">
            <div class="card-header">
                <h6 class="text-lg font-semibold mb-0">Form Tambah Alat Gym</h6>
            </div>
            <div class="card-body">
                <form action="{{ route('alat_gym.store') }}" method="POST">
                    @csrf
                    @method('POST')
                    ...
                    <div class="grid grid-cols-12 gap-4">
                        ...
                        <div class="col-span-12">
                            ...
                            <input type="text" name="nama_alat_gym" class="form-control" value="{{ old('nama_alat_gym') }}" required>
                            @error('nama_alat_gym')
                                <span class="text-danger-600 text-sm">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="col-span-12 md:col-span-6">
                            ...
                            <input type="date" name="tgl_pembelian" class="form-control" value="{{ old('tgl_pembelian') }}">
                            @error('tgl_pembelian')
                                <span class="text-danger-600 text-sm">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="col-span-12 md:col-span-6">
                            ...
                            <input type="text" name="lokasi_alat" class="form-control" value="{{ old('lokasi_alat') }}">
                            @error('lokasi_alat')
                                <span class="text-danger-600 text-sm">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="col-span-12">
                            <div class="form-group flex items-center justify-end gap-2">
                                <button type="submit" class="btn btn-primary-600">Tambah Alat Gym</button>
