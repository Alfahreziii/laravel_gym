                    ...
                    <div class="grid grid-cols-12 gap-4">
                        ...
                        <div class="col-span-12 md:col-span-4">
                            ...
                            <select name="gol_darah" class="form-control @error('gol_darah') is-invalid @enderror" required>
                                ...
                                <option value="A" {{ old('gol_darah', $anggota->gol_darah) == 'A' ? 'selected' : '' }}>A</option>
                                <option value="B" {{ old('gol_darah', $anggota->gol_darah) == 'B' ? 'selected' : '' }}>B</option>
                                <option value="AB" {{ old('gol_darah', $anggota->gol_darah) == 'AB' ? 'selected' : '' }}>AB</option>
                                <option value="O" {{ old('gol_darah', $anggota->gol_darah) == 'O' ? 'selected' : '' }}>O</option>
                            </select>
                            @error('gol_darah')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
