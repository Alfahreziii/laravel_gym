...
@section('content')
        ...
        <div class="col-span-12">
            <div class="card h-full p-0 rounded-xl border-0">
                <div class="card-header border-b border-neutral-200 bg-white py-4 px-6 flex items-center flex-wrap gap-3 justify-between">
                    ...
                    <button type="button" class="btn btn-primary text-sm btn-sm px-3 py-3 rounded-lg flex items-center gap-2" onclick="HexaModal.show('add-language-modal')">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="flex items-center gap-3 justify-center">
                                            <button type="button" class="bg-success-100 text-success-600 bg-hover-success-200 font-medium w-10 h-10 flex justify-center items-center rounded-full" onclick="HexaModal.show('edit-language-modal')">
    ...
    {{-- Add Language Modal --}}
    <x-modal id="add-language-modal" title="Add New Language">
        <x-slot:body>
            <form action="#">
    ...
    {{-- Edit Language Modal --}}
    <x-modal id="edit-language-modal" title="Edit Language">
        <x-slot:body>
            <form action="#">
                <div class="grid grid-cols-12">
                    <div class="sm:col-span-6">
