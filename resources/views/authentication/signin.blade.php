...
<body class="bg-white dark:bg-neutral-900">
    ...
    <div class="flex min-h-screen">
        ...
        <div class="hidden lg:flex lg:w-1/2 relative overflow-hidden flex-col flex-shrink-0">
            ...
            <img src="{{ asset('assets/images/auth/auth-img.png') }}" alt="Gym TradeFitness"
                class="absolute inset-0 w-full h-full object-cover">

            {{-- Layer 2: Overlay gradient oranye semi-transparan --}}
            <div class="absolute inset-0 bg-gradient-to-br from-primary-600/85 via-primary-700/80 to-primary-900/90">
            </div>
            ...
            <div class="relative z-10 flex flex-col h-full px-11 py-11">
                ...
                <div class="flex items-center gap-3">
                    <div>
                        ...
                        <div class="text-[11px] text-white/85 font-medium tracking-[0.04em] mt-0.5">Gym Management
                            System</div>
                    </div>
                </div>
                ...
                <div class="mt-auto max-w-[420px]">
                    ...
                    <p class="mt-4 text-sm leading-relaxed text-white/90">
                        Keanggotaan, kehadiran, kasir, dan keuangan — semua terpantau real-time dalam satu dashboard
                        yang ringkas.
                    </p>
                </div>
        ...
        <div class="flex-1 flex items-center justify-center px-6 py-12 bg-white dark:bg-neutral-800">
            <div class="w-full max-w-[384px]">
                ...
                <p class="mt-2 text-sm text-ink-2 dark:text-ink-d2">
                    Masuk ke panel admin TradeFitness untuk melanjutkan.
                </p>

                {{-- Error --}}
                @if ($errors->any())
                    <div
                        class="mt-5 flex items-start gap-3 px-4 py-3 rounded-xl bg-danger-50 border border-danger-200 dark:bg-danger-600/10 dark:border-danger-600/30">
                        <iconify-icon icon="lucide:alert-circle"
                            class="text-danger-600 text-lg mt-0.5 flex-none"></iconify-icon>
                ...
                <form method="POST" action="{{ route('login') }}" class="mt-6">
                    ...
                    <div class="flex flex-col gap-2 mb-4">
                        ...
                        <div class="relative flex items-center">
                            ...
                            <input type="email" id="email" name="email" value="{{ old('email') }}"
                                ...
                                placeholder="admin@tradefitness.id" required autofocus>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col gap-2">
                        <div class="flex items-center justify-between">
                            <label for="your-password" class="text-xs font-semibold text-ink-2 dark:text-ink-d2">Kata
                                sandi</label>
                        ...
                        <div class="relative flex items-center">
                            ...
                            <span
                                class="toggle-password ri-eye-line cursor-pointer absolute end-3 top-1/2 -translate-y-1/2 text-xl text-neutral-400 hover:text-neutral-600"
                ...
                <div class="mt-5 text-center text-sm text-ink-2 dark:text-ink-d2 space-y-1.5">
                    <p>Belum punya akun?
                        <a href="{{ route('register') }}"
                            class="font-semibold text-primary-600 hover:underline">Daftar</a>
                    </p>
                    <p>Ingin bergabung sebagai trainer?
                        <a href="{{ route('register.trainer') }}"
                            class="font-semibold text-primary-600 hover:underline">Daftar di sini</a>
                    </p>
                </div>
